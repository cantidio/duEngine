...
class StaticChico extends GameObject {
  bool walking=false;
  
  StaticChico() : super(null, null, new Point2D.zero());
...
main() {
  ...
  StaticChico chico2 = new StaticChico();
...
//    chico2.animator.changeAnimation("walk");
    ...
    FollowerCamera cam = new FollowerCamera(new Point2D(Display.target.width, Display.target.height), autoZoom: false);
